...
# FUNDIDO_FILE = "../../dataset/dados_fundamentalistas/dados_cleansing_fundidos/VALE3_cleansing_fundamentalista.csv"
FUNDIDO_FILE = "../../dataset/dados_fundamentalistas/dados_cleansing_fundidos/ABEV3_cleansing_fundamentalista.csv"
# FUNDIDO_FILE = "../../dataset/dados_fundamentalistas/dados_cleansing_fundidos/ITUB4_cleansing_fundamentalista.csv"

# Caminho absoluto baseado na localização do script atual
csv_path = Path(__file__).resolve().parent / FUNDIDO_FILE
...
df_train = df.iloc[:size_train].copy()
df_test  = df.iloc[size_train:size_train+size_test].copy()
